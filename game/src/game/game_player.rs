...
use self::{
    draw_ui::{DisplayedSongNote, UIContent},
    process_notes::{NoteAccuracy, NoteProcessor},
...
pub(crate) fn play_song(
    ...
    let mut texture = texture_creator
        .create_texture_streaming(PixelFormatEnum::IYUV, video_file_size.0, video_file_size.1)
